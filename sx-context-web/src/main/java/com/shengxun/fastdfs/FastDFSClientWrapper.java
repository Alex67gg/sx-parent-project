...
public class FastDFSClientWrapper {
    ...
    private String getResAccessUrl(StorePath storePath) {
        String fileUrl = FastDFSConstants.HTTP_PRODOCOL + "://" + fdfsConfig.getResHost() + "/" + storePath.getFullPath();
        return fileUrl;
    }
    ...
    public String uploadFiles(MultipartFile file) throws IOException {
        StorePath storePath = storageClient.uploadFile(file.getInputStream(),file.getSize(), FilenameUtils.getExtension(file.getOriginalFilename()),null);
      return  new StringBuilder().append("/").append(storePath.getGroup()).append("/").append(storePath.getPath()).toString();
    }
